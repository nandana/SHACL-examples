...
public class TopBraidSHACLExample {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        // Load the shacl Model (this includes the default SHACL related definitions that are used
        ...
        URI shapesGraphURI = URI.create("urn:shacl-shapes-graph:" + UUID.randomUUID().toString());
